document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFormErrors(form) {
    ...
    const errorFields = form.querySelectorAll('.field-error, .field-valid');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "כנף מובייל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'd0b74e4a-bafb-4c85-a94e-4016353c16c2',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'd0b74e4a-bafb-4c85-a94e-4016353c16c2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd0b74e4a-bafb-4c85-a94e-4016353c16c2';
